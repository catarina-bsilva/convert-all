...
import DB from '/src/calBD/volumeDB.json'
export default {
    components:{
        Modal,
        InputNumMed,
    ...
    data () {
        return {
            Ops: ["Cubic Meter", "Liter", "Milliliter", "US Gallon", "US Quart", "US Pint", "US Cup", "US Fluid Ounce", "US Tablespoon", "US Teaspoon", "Imperial Gallon", "Imperial Quart", "Imperial Pint", "Imperial Cup", "Imperial Fluid Ounce" ],
            Value: 0,
            FromType: "Cubic Meter",
            ToType: "Cubic Meter",
            Total: 0
        }      
    }, 
    methods : {
        resetForm() {
            this.Value= 0
            this.FromType= "Cubic Meter"
            this.ToType= "Cubic Meter"
            this.Total = 0
        },
